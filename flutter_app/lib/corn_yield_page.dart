              ...
              children: [
                SizedBox(
                  ...
                  child: DropdownButtonFormField<String>(
                    value: _district,
                    decoration: _fieldDecoration("District", "Choose district"),
                    items: _districts
                        .map((d) => DropdownMenuItem(value: d, child: Text(d)))
                        .toList(),
                    onChanged: (val) => setState(() => _district = val ?? _district),
                  ),
                ),
                SizedBox(
                  width: 420,
                  child: DropdownButtonFormField<String>(
                    value: _variety,
                    decoration: _fieldDecoration("Variety", "Select variety"),
                    items: _varieties
                        .map((v) => DropdownMenuItem(value: v, child: Text(v.replaceAll("_", " "))))
                        .toList(),
                    onChanged: (val) => setState(() => _variety = val ?? _variety),
                  ),
                ),
                SizedBox(
                  width: 420,
                  child: TextFormField(
                    ...
                    decoration: _fieldDecoration("Farm size (acres)", "0.8"),
                ...
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    keyboardType: TextInputType.number,
                    decoration: _fieldDecoration("Seasonal rainfall (mm)", "1200"),
                    validator: _numberValidator,
                  ),
                ),
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    keyboardType: TextInputType.number,
                    decoration: _fieldDecoration("Fertilizer (kg/acre)", "2"),
                    validator: _numberValidator,
                  ),
                ),
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    keyboardType: TextInputType.number,
                    decoration: _fieldDecoration("Previous yield (kg/acre)", "2"),
                    validator: _numberValidator,
                  ),
                ),
              ],
                ...
                Expanded(
                  child: OutlinedButton.icon(
                    ...
                    style: OutlinedButton.styleFrom(
                      ...
                      side: const BorderSide(color: Color(0xFFDC3C3C), width: 1.1),
                      padding: const EdgeInsets.symmetric(vertical: 14),
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          "${f.shapValue.toStringAsFixed(1)} | ${_effectText(f.shapValue)}",
                          style: GoogleFonts.manrope(
          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                ...
                width: width,
                decoration: BoxDecoration(
                  color: isPositive ? const Color(0xFF5BBF75) : const Color(0xFFE2695E),
                  borderRadius: BorderRadius.circular(999),
                ),
              ),
            ),
